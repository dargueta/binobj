    ...
    def __new__(mcs, name, bases, namespace):
        ...
        for i, (f_name, field) in enumerate(namespace['__components__'].items()):
            ...
            if offset is not None:
                ...
                if field._n_bits is None or isinstance(field._n_bits, ValueOf):
                    offset = None
                else:
...
class ValueOf:
    ...
    def __init__(self, value_source, *operands, xform_fn=None):
        ...
        elif isinstance(value_source, SerializableScalar):       # FIXME
    ...
    def compute_for_dumping(self, data_dict):
        ...
        if isinstance(self.value_source, SerializableScalar):
    ...
    def _compute_dumping_field(self, data_dict):
        ...
        elif self.value_source._options['required'] is True:
            raise errors.MissingRequiredValueError(field=self.value_source)
        return self.value_source._options['default']
